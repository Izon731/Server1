--[[
addons/hl2rp_weapons_base/lua/weapons/swb_base/shared.lua
--]]
...
SWEP.FireModeNames = {["auto"] = {display = "АВТОМАТИКА", auto = true, burstamt = 0, buldis = 5},
	["semi"] = {display = "ОДИНОЧНЫЙ", auto = false, burstamt = 0, buldis = 1},
	["double"] = {display = "ОДИНОЧНЫЙ ВЫСТРЕЛ", auto = false, burstamt = 0, buldis = 1},
	["bolt"] = {display = "БОЛТОВКА", auto = false, burstamt = 0, buldis = 1},
	["pump"] = {display = "ПОМПОВОЕ", auto = false, burstamt = 0, buldis = 1},
	["break"] = {display = "ОДИНОЧНЫЙ", auto = false, burstamt = 0, buldis = 1},
	["2burst"] = {display = "КОРОТКАЯ ОЧЕРЕДЬ", auto = true, burstamt = 2, buldis = 2},
	["3burst"] = {display = "КОРОТКАЯ ОЧЕРЕДЬ", auto = true, burstamt = 3, buldis = 3},
